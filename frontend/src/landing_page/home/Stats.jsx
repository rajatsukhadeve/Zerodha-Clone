        ...
        <div className="container p-5">
            <div className="row ">
                <div className="col-6 p-5">
                    ...
                    <h2 className="fs-4 mt-4 mb-2">No spam or gimmicks </h2>
                    <p className="text-muted">No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like. Our philosophies.</p>

                    <h2 className="fs-4 mt-4 mb-2">The Zerodha universe</h2>
                    <p className="text-muted">Not just an app, but a whole ecosystem. Our investments in 30+ fintech startups offer you tailored services specific to your needs.</p>

                    <h2 className="fs-4 mt-4 mb-2">Do better with money</h2>
                ...
                <div className="col-6 p-5">
                    ...
                    <div className="text-center">
                        ...
                        <a href="" className="text-decoration-none">Try Kite demo  <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
